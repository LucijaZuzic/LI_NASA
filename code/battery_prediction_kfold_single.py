...
for ii, (train_index, test_index) in enumerate(skf1.split(y_soh, y_battery)):
    ...
    # Save XGBoost model
    xgb_model_file_name = os.path.join(models_dir, 'xgboost_soh_model_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.json')
    ...
    with open(os.path.join(models_dir, 'xgb_performance_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        pickle.dump({"MSE": xgb_mse, "MAE": xgb_mae, "R²": xgb_r2}, f)

    # Save XGBoost model size and time
    with open(os.path.join(models_dir, 'xgb_size_time_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
    ...
    with open(os.path.join(models_dir, 'xgb_parameters_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
    ...
    plt.title('XGBoost Feature Importance Number of splits: ' + str(n_splits) + ' Seed: ' + str(random_state) + ' Test fold: ' + str(ii + 1))
    plt.tight_layout()
    plt.savefig(os.path.join(models_dir, 'feature_importance_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png'), dpi=300, bbox_inches='tight')
    plt.close()
    ...
    # Save y_test_xgb_np
    with open(os.path.join(models_dir, 'y_test_xgb_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        pickle.dump(y_test_xgb_np, f)
    # Save y_pred_xgb_np
    with open(os.path.join(models_dir, 'y_pred_xgb_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        pickle.dump(y_pred_xgb_np, f)

    # Save scaler
    with open(os.path.join(models_dir, 'scaler_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
    ...
    for start_size in start_sizes:
        ...
        # Save LSTM model
        lstm_model_file_name = os.path.join(cells_subdir, 'lstm_num_cells_' + str(start_size) + '_soh_model_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.h5')
        ...
        with open(os.path.join(cells_subdir, 'lstm_num_cells_' + str(start_size) + '_performance_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            pickle.dump({"MSE": lstm_mse, "MAE": lstm_mae, "R²": lstm_r2}, f)

        # Save LSTM model size and time
        with open(os.path.join(cells_subdir, 'lstm_num_cells_' + str(start_size) + '_size_time_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        with open(os.path.join(cells_subdir, 'lstm_num_cells_' + str(start_size) + '_parameters_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        plt.title('LSTM Model Training Cells: ' + str(start_size) + ' Number of splits: ' + str(n_splits) + ' Seed: ' + str(random_state) + ' Test fold: ' + str(ii + 1))
        plt.xlabel('Epoch')
        plt.ylabel('Loss (MSE)')
        plt.legend()
        plt.grid(True)
        plt.savefig(os.path.join(cells_subdir, 'lstm_num_cells_' + str(start_size) + '_training_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png'), dpi=300, bbox_inches='tight')
        plt.close()
        
        # Save history
        with open(os.path.join(cells_subdir, 'lstm_num_cells_' + str(start_size) + '_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        # Save y_test_lstm_np
        with open(os.path.join(cells_subdir, 'y_test_lstm_num_cells_' + str(start_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            pickle.dump(y_test_lstm_np, f)
        # Save y_pred_lstm_np
        with open(os.path.join(cells_subdir, 'y_pred_lstm_num_cells_' + str(start_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        lstm_selu_model_file_name = os.path.join(cells_subdir, 'lstm_selu_num_cells_' + str(start_size) + '_soh_model_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.h5')
        ...
        with open(os.path.join(cells_subdir, 'lstm_selu_num_cells_' + str(start_size) + '_performance_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            pickle.dump({"MSE": lstm_selu_mse, "MAE": lstm_selu_mae, "R²": lstm_selu_r2}, f)

        # Save LSTM SELU model size and time
        with open(os.path.join(cells_subdir, 'lstm_selu_num_cells_' + str(start_size) + '_size_time_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        with open(os.path.join(cells_subdir, 'lstm_selu_num_cells_' + str(start_size) + '_parameters_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        plt.figure(figsize=(10, 4))
        plt.plot(history.history['loss'], label='Training Loss')
        plt.title('LSTM SELU Model Training Cells: ' + str(start_size) + ' Number of splits: ' + str(n_splits) + ' Seed: ' + str(random_state) + ' Test fold: ' + str(ii + 1))
        plt.xlabel('Epoch')
        plt.ylabel('Loss (MSE)')
        plt.legend()
        plt.grid(True)
        plt.savefig(os.path.join(cells_subdir, 'lstm_selu_num_cells_' + str(start_size) + '_training_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png'), dpi=300, bbox_inches='tight')
        plt.close()
        
        # Save history
        with open(os.path.join(cells_subdir, 'lstm_selu_num_cells_' + str(start_size) + '_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            pickle.dump(history, f)
        ...
        with open(os.path.join(cells_subdir, 'y_test_lstm_selu_num_cells_' + str(start_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            pickle.dump(y_test_lstm_selu_np, f)
        # Save y_pred_lstm_selu_np
        with open(os.path.join(cells_subdir, 'y_pred_lstm_selu_num_cells_' + str(start_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        # Save LSTM Att model
        lstm_att_model_file_name = os.path.join(cells_subdir, 'lstm_att_num_cells_' + str(start_size) + '_soh_model_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.h5')
        ...
        with open(os.path.join(cells_subdir, 'lstm_att_num_cells_' + str(start_size) + '_performance_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            pickle.dump({"MSE": lstm_att_mse, "MAE": lstm_att_mae, "R²": lstm_att_r2}, f)

        # Save LSTM Att model size and time
        with open(os.path.join(cells_subdir, 'lstm_att_num_cells_' + str(start_size) + '_size_time_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        with open(os.path.join(cells_subdir, 'lstm_att_num_cells_' + str(start_size) + '_parameters_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        plt.figure(figsize=(10, 4))
        plt.plot(history.history['loss'], label='Training Loss')
        plt.title('LSTM Att Model Training Cells: ' + str(start_size) + ' Number of splits: ' + str(n_splits) + ' Seed: ' + str(random_state) + ' Test fold: ' + str(ii + 1))
        plt.xlabel('Epoch')
        plt.ylabel('Loss (MSE)')
        plt.legend()
        plt.grid(True)
        plt.savefig(os.path.join(cells_subdir, 'lstm_att_num_cells_' + str(start_size) + '_training_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png'), dpi=300, bbox_inches='tight')
        plt.close()
        
        # Save history
        with open(os.path.join(cells_subdir, 'lstm_att_num_cells_' + str(start_size) + '_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            pickle.dump(history, f)
        ...
        with open(os.path.join(cells_subdir, 'y_test_lstm_att_num_cells_' + str(start_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            pickle.dump(y_test_lstm_att_np, f)
        # Save y_pred_lstm_att_np
        with open(os.path.join(cells_subdir, 'y_pred_lstm_att_num_cells_' + str(start_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        if test_bi:
            ...
            bi_model_file_name = os.path.join(cells_subdir, 'bi_num_cells_' + str(start_size) + '_soh_model_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.h5')
            callbacks = return_callbacks(bi_model_file_name, 'loss')
            ...
            with open(os.path.join(cells_subdir, 'bi_num_cells_' + str(start_size) + '_performance_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
                pickle.dump({"MSE": bi_mse, "MAE": bi_mae, "R²": bi_r2}, f)

            # Save Bi model size and time
            with open(os.path.join(cells_subdir, 'bi_num_cells_' + str(start_size) + '_size_time_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            ...
            with open(os.path.join(cells_subdir, 'bi_num_cells_' + str(start_size) + '_parameters_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            ...
            plt.title('Bi Model Training Cells: ' + str(start_size) + ' Number of splits: ' + str(n_splits) + ' Seed: ' + str(random_state) + ' Test fold: ' + str(ii + 1))
            plt.xlabel('Epoch')
            plt.ylabel('Loss (Binary Crossentropy)')
            plt.legend()
            plt.grid(True)
            plt.savefig(os.path.join(cells_subdir, 'bi_num_cells_' + str(start_size) + '_training_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png'), dpi=300, bbox_inches='tight')
            plt.close()
            
            # Save Bi history
            with open(os.path.join(cells_subdir, 'bi_num_cells_' + str(start_size) + '_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
            ...
            # Save y_test_bi_np
            with open(os.path.join(cells_subdir, 'y_test_bi_num_cells_' + str(start_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
                pickle.dump(y_test_bi_np, f)
            # Save y_pred_bi_np
            with open(os.path.join(cells_subdir, 'y_pred_bi_num_cells_' + str(start_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
        ...
        if test_conv:
            for kernel_size in kernel_sizes:
                ...
                conv_model_file_name = os.path.join(kernel_subdir, 'conv_num_cells_' + str(start_size) + '_kernel_size_' + str(kernel_size) + '_soh_model_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.h5')
                callbacks = return_callbacks(conv_model_file_name, 'loss')
                optimizer = tf.keras.optimizers.Adam(learning_rate=0.01)
                ...
                with open(os.path.join(kernel_subdir, 'conv_num_cells_' + str(start_size) + '_kernel_size_' + str(kernel_size) + '_performance_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
                    pickle.dump({"MSE": conv_mse, "MAE": conv_mae, "R²": conv_r2}, f)

                # Save Conv model size and time
                with open(os.path.join(kernel_subdir, 'conv_num_cells_' + str(start_size) + '_kernel_size_' + str(kernel_size) + '_size_time_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
                ...
                with open(os.path.join(kernel_subdir, 'conv_num_cells_' + str(start_size) + '_kernel_size_' + str(kernel_size) + '_parameters_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
                ...
                plt.title('Conv Model Training Cells: ' + str(start_size) + ' Kernel: ' + str(kernel_size) + ' Number of splits: ' + str(n_splits) + ' Seed: ' + str(random_state) + ' Test fold: ' + str(ii + 1))
                plt.xlabel('Epoch')
                plt.ylabel('Loss (Binary Crossentropy)')
                plt.legend()
                plt.grid(True)
                plt.savefig(os.path.join(kernel_subdir, 'conv_num_cells_' + str(start_size) + '_kernel_size_' + str(kernel_size) + '_training_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png'), dpi=300, bbox_inches='tight')
                plt.close()

                # Save Conv history
                with open(os.path.join(kernel_subdir, 'conv_num_cells_' + str(start_size) + '_kernel_size_' + str(kernel_size) + '_history_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
                ...
                # Save y_test_conv_np
                with open(os.path.join(kernel_subdir, 'y_test_conv_num_cells_' + str(start_size) + '_kernel_size_' + str(kernel_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
                    pickle.dump(y_test_conv_np, f)
                # Save y_pred_conv_np
                with open(os.path.join(kernel_subdir, 'y_pred_conv_num_cells_' + str(start_size) + '_kernel_size_' + str(kernel_size) + '_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.pkl'), 'wb') as f:
    ...
    file_name_performance = os.path.join(models_dir, 'model_performance_comparison_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png')
    file_name_size_time = os.path.join(models_dir, 'model_size_time_comparison_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png')
    file_name_parameters = os.path.join(models_dir, 'model_parameters_comparison_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(models_dir, 'model_predictions_n_splits_' + str(n_splits) + '_seed_' + str(random_state) + '_test_fold_' + str(ii + 1) + '.png'), dpi=300, bbox_inches='tight')
    plt.close()